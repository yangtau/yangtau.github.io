...
### 单周期 MIPS CPU
<a href="https://github.com/yangtau/mips-cpu"><img src="https://gh-card.dev/repos/yangtau/mips-cpu.svg"></a>
...
### Feed the Dragon 游戏
<a href="https://github.com/yangtau/feed-the-dragon"><img src="https://gh-card.dev/repos/yangtau/feed-the-dragon.svg"></a>
一个软件工程课上写的游戏，使用 PyGame 开发，游戏 UI 使用了 Pygame GUI 库（当时这个库还很粗糙，我还给它贡献了几个 PR）。

### CSAPP
<a href="https://github.com/yangtau/csapp"><img src="https://gh-card.dev/repos/yangtau/csapp.svg"></a>
学习 CSAPP 这本书时所做的笔记和实验。实验部分收获很大，包括实现 malloc、HTTP 代理等。

### SMS
<a href="https://github.com/yangtau/SMS"><img src="https://gh-card.dev/repos/yangtau/SMS.svg"></a>
...
### UESTC 课表
<a href="https://github.com/yangtau/uestc"><img src="https://gh-card.dev/repos/yangtau/uestc.svg"></a>
